from cointegration import extract_close_prices, calculate_cointegration, calculate_spread, calculate_zscore
...
def plot_trends(sym_1, sym_2, price_data):
    ...
    coint_flag,p_value,t_value,critical_value,hedge_ratio,zero_crossing = calculate_cointegration(prices_1, prices_2)
    ...
    df_2[sym_2] = prices_2
    df_2["Spread"] = spread
    df_2["Z-Score"] = z_score

    df_2.to_csv("3_backtest_file.csv")
    print("File for backtest saved")
